...
public final class TmNettyRemotingClient extends AbstractNettyRemotingClient {
    ...
    // 这2个东西 是 seata start 配置的 如果没有配置则是null
    ...
    private void registerProcessor() {
        // 这个东西 在启动的时候是为空的 暂时不知道是个啥 先过
        TransactionMessageHandler transactionMessageHandler = getTransactionMessageHandler();
        // 1.registry TC response processor
        ClientOnResponseProcessor onResponseProcessor =
            new ClientOnResponseProcessor(mergeMsgMap, super.getFutures(),transactionMessageHandler);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sb.append("aaa").append((String) null).toString());
    }

    /**
     *  扩展参数 是 IP:PORT [签名:如果有severtkey的话]
     *
     * @return
     */
